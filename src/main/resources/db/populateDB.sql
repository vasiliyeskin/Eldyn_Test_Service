...
VALUES
  ...
  ('НАУЧНО-ИССЛЕДОВАТЕЛЬСКАЯ ПРАКТИКА', 'НАУЧНО-ИССЛЕДОВАТЕЛЬСКУЮ ПРАКТИКУ','02.02.2018', '03.05.2018'),
  ('ПРЕДДИПЛОМНАЯ ПРАКТИКА', 'ПРЕДДИПЛОМНУЮ ПРАКТИКУ','02.02.2018', '03.05.2018');
