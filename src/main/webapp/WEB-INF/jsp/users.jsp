            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="lastname" class="control-label col-xs-3"><spring:message code="student.lastname"/></label>

                        <div class="col-xs-9">
                            <input type="text" class="form-control" id="lastname" name="lastname" placeholder="<spring:message code="student.lastname"/>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="firstname" class="control-label col-xs-3"><spring:message code="student.firstname"/></label>

                        <div class="col-xs-9">
                            <input type="text" class="form-control" id="firstname" name="firstname" placeholder="<spring:message code="student.firstname"/>">
                        </div>
                    </div>
